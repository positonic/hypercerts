  ...
  BatchOrderTypehashRegistry
{
   ...
   */
  function _payProtocolFeeAndAffiliateFee(address currency, address bidUser, uint256 totalProtocolFeeAmount) internal {
  ...
  function _getUnitsHeldByHypercertFractions(
    address collection,
    uint256[] memory itemIds
  ) public view returns (uint256 unitsHeldByItems) {
